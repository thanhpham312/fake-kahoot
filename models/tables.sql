...
SELECT "USERNAME", "SCORE", "HIGHEST_STREAK", "DATE"
FROM public."SCORES", public."ACCOUNTS"
WHERE "QUIZ_CATEGORY_ID" = '9' AND "DIFFICULTY_ID" = '1'
AND public."SCORES"."ACCOUNT_ID" = public."ACCOUNTS"."ACCOUNT_ID" ORDER BY "SCORE" DESC;